...
void updateHuman(const i2r_baxter_motion::Human & data)
{
...
void updateRobot(const i2r_baxter_motion::RobotData& data)
{
	//x: s_r
	//y: robot_status
...
void updateTrust(const i2r_baxter_motion::TrustData& data)
{
...
//	sqpspecify->setMaxFun(20);	//Maximal number of function evaluations
	...
	ros::Publisher debug_pub = node.advertise<i2r_baxter_motion::TrustMsg>("/trust/debug_solver",1);
	...
	i2r_baxter_motion::TrustMsg debug_states;
	OptimalDiff::calc();
